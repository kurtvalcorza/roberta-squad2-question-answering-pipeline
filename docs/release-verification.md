...
|---|---|---|---|---|---|
| 2026-09-14 | `9473216` / `5a73f16cf5cd` | Kaggle CPU (`kurtvalcorza/dimer-nb2-roberta-question-answering` v1) | Default sample path | 233.8 s | **PASSED** — 8/8 ok code cells executed cleanly, 16 files, 498 MB staged |
