...
MARKDOWN_MARKERS = (
    "**Capability:** extractive question answering with the SQuAD 2.0 unanswerable case",
    "**CC-BY-4.0**",
    "**extractive reader**",
    ...
    "**not an accuracy**",
    "**rejects with a `ValueError` naming the count, never silently truncates or windows**",
